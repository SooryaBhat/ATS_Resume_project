...
ALLOWED_ORIGINS = [
    'https://talentmatch-m79g658p0-sooryabhats-projects.vercel.app',  # Vercel Production Deployment
...
SPACY_MODEL_SECONDARY = 'en_core_web_sm'   # Fixed: removed erroneous leading quote
